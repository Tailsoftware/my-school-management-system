...
<!-- e -->
   ...
   <?php
                ...
                $query2 = "SELECT * FROM movement WHERE school ='$school' AND campus = '$campusselect' ORDER BY id DESC";
...
<!-- s -->
                        ...
                        <td class="dc" style=" line-break: break-all;"> <a href="" class="teachersdetails"><?=$uniqe?> <input type="hidden" name="teacherid" value="<?=$uniqe?>" class="teacherid"> <input type="hidden" class="campusselect" value="<?=$campusselect?>"></a></td>
                        <td class="dc"><?=$reason?></td>
                        <td class="dc"><?=$status?></td>
                        <td class="dc"><?=$date?></td>
