   ...
   if(isset($_POST['content']) AND $_FILES['postimg']['size']>0 AND  isset($_POST['campus'])  AND isset($_POST['poster'])  AND isset($_POST['header']) AND isset($_POST['eventtype'])  ){
      ...
      if(in_array($ext,$extarray)){
        if(file_exists($destination)){
            ...
            if($type =='email'){
              $query ="SELECT * FROM teachers WHERE school='$myschool' AND campus ='$campusselect'";
             ...
             while($result = mysqli_fetch_assoc($send)){
              ...
              $email = $result['email'];
              sendmail($content,$email,$firstname,$lastname,$myschool,$adminemail,$imgname);

             }
              $query ="SELECT * FROM officestaf WHERE school='$myschool' AND campus ='$campusselect'";
             ...
             while($result = mysqli_fetch_assoc($send)){
              ...
              $query ="SELECT * FROM students WHERE school='$myschool' AND campus ='$campusselect'";
            ...
            if($type =='email'){
             ...
             while($result = mysqli_fetch_assoc($send)){
              ...
              $lastname = $result['lastname'];
              $email = $result['email'];
              sendmail($content,$email,$firstname,$lastname,$school,$adminemail,$imgname);

             }
              $query ="SELECT * FROM officestaf WHERE school='$school' AND campus ='$campusselect'";
...
<!-- link -->
        ...
        <div class="row m-0 position-relative  justify-content-center w-100 sh gap-2 " style="overflow-y: scroll; height: 90%;padding: 1cm; background-color: rgba(128, 128, 128, 0.39);">
            ...
            <div class=" <?=$edit?>   col-12 col-md-8 bg-light mb-4 p-2" style="height: 400px; border-radius: 10px; ">
            <form action="<?=$_SERVER['PHP_SELF']?>" method="POST" enctype="multipart/form-data">
                <div class="formbox col-12">
                    ...
                    <input type="radio" class="form-check-input" name="eventtype" value="email">
               ...
               <?php
                ...
                <div class="formbox col-12">
                  <input type="submit" class="form-control mt-4 bg-dark text-light" value="Publish">
        ...
        <!--select post from newsandevent table depending on user b -->
         ...
         if($section =='admin'){
            ...
            $query = "SELECT * FROM newsandevent WHERE school = '$school'";
            $send = $conn->query($query);
            $resultnum = mysqli_num_rows($send);
            for($i = 0;$i < $resultnum; $i++){
              $result = mysqli_fetch_assoc($send);
            ...
            ?>
                ...
                </form>                    <img src="../upload/<?=$postimg?>" alt="" class="card-img-top" style="max-height: 150px;">
           ...
           if($section == 'teacher' OR $section == 'student'){
            $query = "SELECT * FROM newsandevent WHERE school = '$school' AND campus = '$campus'";
