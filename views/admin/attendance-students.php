 ...
 $id = $_POST['idsubject'];
   ...
   ');
    ...
    <input type="hidden" id="'.$uniqe.'" value="'.$campusselect.'" class="'.$class.'" >
     ...
     <td>
      <button class="btn btn-success text-dark" onclick="present('.$uniqe.')">Present</button>
      <button class="btn btn-danger text-light" onclick="absent('.$uniqe.')">Absent</button>
...
<!-- link -->
  ...
  <form action="" class="col-12 d-none" >
      ...
      <table class="tablem d-flex flex-column   thestudentlist2 " style="text-transform: capitalize;"  >
...
<!--  -->
            <div class="  col-10 m-auto h-75 box1" style="overflow:scroll;">
...
<!-- -->
               ...
               <div class="table-responsive  overflow-scroll w-100  d-flex justify-content-center mt-3 ">
