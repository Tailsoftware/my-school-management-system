  ...
  <div class=" d-none popperteachersdetails popperdetails position-fixed d-flex justify-content-center align-items-center " style="height: 100%; width:100% ;z-index: 10; top: 0; left: 0; background-color: rgba(0, 0, 0, 0.808);">
    ...
    <div class="col-12 pt-5  d-flex flex-column g-2 align-items-center  appentteachersresponse" style="height: 90%; overflow-y: scroll; padding-bottom: 1cm ;">
     ...
     <!-- popperteachere -->
            ...
            <form action="<?=$_SERVER['PHP_SELF']?>" method="POST" class="" style="width: 100%;">
               ...
               <div class="table-responsive col-12  overflow-scroll mt-4">
                   ...
                   ?>
                     ...
                     <td class="" style="width: 3cm; height:2cm;">
                         <div id="" class=" position-relative  mt-5 " style="width: 100%; height: 100%; cursor: pointer;">
                             ...
                             <ul class=" d-none subjectlist table-responsive  position-absolute top-0 drop bg-light " style="width: 300px; z-index: 10; max-height: 200px; overflow-y: scroll;">
                                 <a href="" class="btn btn-warning editsubject"> <input type="hidden" value="<?=$class?>">Add</a>
                                 <button class="btn btn-outline-danger closesubject" style="float:right; ">X</button>
