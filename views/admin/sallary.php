...
<!-- e -->
   ...
   <?php
                    ...
                    $query2 = "SELECT * FROM teachers WHERE school ='$school' AND campus = '$campusselect' AND lastattendance LIKE '$d%'";
   ...
   $resultnum2 = mysqli_num_rows($send2);
     ...
     while( $result2 = mysqli_fetch_assoc($send2)){
      ...
      $j++;
        ...
        $query2 = "SELECT * FROM attendance WHERE school ='$school' AND campus = '$campusselect' AND section='teachers' AND uniqe = '$id' AND datetime LIKE '$d%'";
        $send = $conn->query($query2);
              $teachersatt = mysqli_num_rows($send);
               $salary = $salary*$teachersatt;
               $salary = round($salary);
    ?>
...
<!-- e -->
 ...
 <?php
    ...
    $query2 = "SELECT * FROM officestaf WHERE school ='$school' AND campus = '$campusselect' AND lastattendance LIKE '$d%'";
    $send2 = $conn->query($query2);
$resultnum2 = mysqli_num_rows($send2);
$j = 0;
if($resultnum2>0){
...
$query2 = "SELECT * FROM attendance WHERE school ='$school' AND campus = '$campusselect' AND section='staff' AND uniqe = '$id' AND datetime LIKE '$d%'";
$send = $conn->query($query2);
$teachersatt = mysqli_num_rows($send);
$salary = $salary*$teachersatt;
$salary = round($salary);
