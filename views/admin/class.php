 ...
 $id = $_POST['idsubject'];
   ...
   ');
    ...
    <input type="hidden" id="'.$uniqe.'" value="'.$campusselect.'">
     ...
     <td>
      <button class="btn btn-danger text-dark" onclick="b('.$uniqe.')">Delete</button>
...
<!-- link -->
        ...
        <!-- body -->
        <div class="body flex-grow-1 bg-light  align-items-center d-flex col-12 " style="height: 100%;overflow:hidden;">
...
<div class="col-12 col-md-7 h-75  m-auto position-relative bg-light ps-3" style=" border-radius:10px">
    <button class="btn btn-danger float-end close">X</button>
    <div class="col-12 col-md-11 pt-5  d-flex flex-column g-2 align-items-center m-auto" style="height: 90%; padding-bottom: 1cm ;">
...
<table class="tablem d-flex flex-column  thestudentlist " style="text-transform: capitalize;"  >
...
<div class=" d-none poppereditclass popperdetails position-fixed d-flex justify-content-center align-items-center " style="height: 100%; width:100% ;z-index: 10; top: 0; left: 0; background-color: rgba(0, 0, 0, 0.808);">
    ...
    <div class="col-12 pt-5  d-flex flex-column g-2 align-items-center " style="height: 90%; overflow-y: scroll; padding-bottom: 1cm ;">
            ...
            <form action="<?=$_SERVER['PHP_SELF']?>" class="col-12 d-flex justify-content-center flex-column a" id="editclassform" method="POST" enctype="multipart/form-data">
                ...
                <div class="formbox mt-3">
                    <input type="submit" class="form-control bg-dark text-light" style="" value="update">
...
<!--  -->
<div class="col-12 col-md-7 h-75   position-relative loopt" style="" >
<!-- -->
           
<form action="<?=$_SERVER['PHP_SELF']?>" method="POST" class="<?=$adddclass?>" style="width: 100%;">
               ...
               <div class="table-responsive col-12  h-100 " style="overflow:scroll">
...
<tr class=" " style="font-weight: 600;min-width:100%">
       ...
       <td style="">teacher</td>
       <td style="">subject</td>
       <td style="">time table</td>
       <td style=""> Scheme</td>
       <td style="">Take Home</td>
       <td style="">action</td>
...
<!-- e -->
                  ...
                  $resultnum2 = mysqli_num_rows($send2);
                   ...
                   ?>
                     ...
                     <td class="" style="width: 3cm; height:2cm;">
                         <div id="" class=" position-relative  mt-5 " style="width: 100%; height: 100%; cursor: pointer;">
                             <span class="popoutsubject "> click  <input class="click" type="hidden" value="<?=$class?>"> <i class="fa fa-arrow-down popoutsubject"></i></span>
                            
                             <ul class=" d-none subjectlist table-responsive  position-absolute top-0 drop bg-secondary" style="width: 300px; z-index: 10; max-height: 200px; overflow: scroll;display:block">
                                <a href="" class="btn btn-warning editsubject" style="height: 1cm;"> <input type="hidden" value="<?=$class?>">Add</a>
                                <button class="btn btn-outline-danger closesubject" style="float:right; height:1cm">X</button>
                      ...
                      $query = "SELECT * FROM `subject` WHERE school = '$school' AND campus = '$campusselect' AND class = '$class'";
                      $send = $conn->query($query);
                      $resultnum = mysqli_num_rows($send);
     
                      while($result = mysqli_fetch_assoc($send)){
                      $subject = $result['subject'];
                      $creditload = $result['creditload'];
                      $id = $result['id'];
                         ...
                         <tr>
                             <th><?=$subject?></th>
                             <th><?=$creditload?></th>
                             <th> <form action="<?=$_SERVER['PHP_SELF']?>" method="POST" id="dsform">
                                <input type="hidden" name="idsubject" value="<?=$id?>">
                               
                                <button class="btn btn-danger dsbuth">X</button>
                            </form></th>
                         </tr>
                           <?php
                      }
                     ...
                     <td class="" style="width: 3cm; height:2cm;">
                          <div class="classimg bg-secondary" style="width: 100%; height: 100%;">
                         <img src="../upload/<?=$timetable?>" alt="" style="width: 100%; height: 100%; display: block;">
                         </div>
                     </td>
                     <td class="" style="width: 3cm; height:2cm;">
                          <div class="classimg bg-secondary" style="width: 100%; height: 100%;">
                         <img src="../upload/<?=$scheme?>" alt="" style="width: 100%; height: 100%; display: block;">
                         </div>
                     </td>
                     <td class="" style="width: 3cm; height:2cm;">
                          <div class="classimg bg-secondary" style="width: 100%; height: 100%;">
                         <img src="../upload/<?=$assignment?>" alt="" style="width: 100%; height: 100%; display: block;">
                         </div>
                     </td>
                     <td class="" style="width: 3cm; height:2cm;">
                      <a href="" class="btn btn-warning editclass">Edit <input type="hidden" class="class" value="<?=$class?>"> </a>
                ...
                <?php
                    ...
                    $query2 = "SELECT * FROM class WHERE school = '$school' AND campus = '$campusselect' AND mclass ='$myclass'";
                    $send2 = $conn->query($query2);
                  $resultnum2 = mysqli_num_rows($send2);
                    $j = 0;
                    for($i=0;$i<$resultnum2;$i++){
   ...
   <div class=" d-none   poppereditsubject popperdetails position-fixed d-flex justify-content-center align-items-center " style="height: 100%; width:100% ;z-index: 10; top: 0; left: 0; background-color: rgba(0, 0, 0, 0.808);">
    ...
    <div class="col-12   d-flex flex-column gap-2 align-items-center  " style="height: 100%;padding-bottom: 1cm ;">
                ...
                <form action="<?=$_SERVER['PHP_SELF']?>" method="POST" class="w-100" id="formsubject" style="">
                    ...
                    <button class="btn btn-dark addsubjectbuth">Add</button>
                    </div>
                </form>
