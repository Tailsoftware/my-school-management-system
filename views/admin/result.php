 ...
 $id = $_POST['idsubject'];
   ...
   ');
    ...
    <input type="hidden" id="'.$uniqe.'" value="'.$campusselect.'">
     ...
     <td style="width: 3.5cm;padding-left: 10px;">'.$i.'</td>
     ...
     ');
       $query2 = "SELECT * FROM examp WHERE uniqe ='$uniqe' AND date > '$sessionstart' AND date <'$sessionend'";
       ...
       $subject = $result2['subject'];
        $score = $result2['totalscore'];
        $test1 = $result2['test1'];
        $test2 = $result2['test2'];

        echo('
        <tr>
        <th class="dc" >'.$subject.'</th>
        <td class="dc" >
        <table class="table table-striped">

        <tr>
        <th class="dc" >Exam</th>
        <th class="dc" >Test1</th>
        <th class="dc" >Test2</th>

        </tr>
        <tr>
        <th class="dc" >'.$score.'</th>
        <th class="dc" >'.$test1.'</th>
        <th class="dc" >'.$test2.'</th>
...
<div class="  d-none popperclasslist popperdetails position-fixed d-flex justify-content-center align-items-center " style="height: 100%; width:100% ;z-index: 10; top: 0; left: 0; background-color: rgba(0, 0, 0, 0.808);">
    ...
    <div class="col-12 col-md-7 bg-light position-relative" style="border-radius: 10px;height: 100%; padding: 10px;">
...
<table class="tablem d-flex flex-column  thestudentlistd5 " style="text-transform: capitalize;"  >
     ...
     <tr class="table-active" style="font-weight: 600;">
             ...
             <td>Firstname</td>
             <td>Lastname</td>
             <td style="min-width: 200px;">subjects</td>
...
<div class=" d-flex gap-3 m-3">
       ...
       <a href="result.php" class="btn btn-primary text-capitalize text-light" style="width: 1.5cm;">View</a>

       <a href="check.php" class="btn btn-dark text-capitalize text-light" style="">Check</a>
       </div>
<!-- -->
