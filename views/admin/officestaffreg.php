...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
   ...
   if(isset($_POST['firstname']) AND isset($_POST['lastname'])  AND isset($_POST['salary'])  AND isset($_POST['sec'])  AND isset($_POST['homeaddr'])  AND isset($_POST['gender'])  AND isset($_POST['qualification'])  AND isset($_POST['fmember'])  AND isset($_POST['ffirstname'])  AND isset($_POST['flastname'])  AND isset($_POST['email'])  AND isset($_POST['campus']) AND isset($_POST['phonenumber']) AND isset($_POST['fnumber'])  ){
   
   
      if($_POST['firstname'] !="" AND  $_POST['lastname']!="" AND  $_POST['salary']!=""  AND $_POST['sec'] !="" AND $_POST['homeaddr'] !="" AND $_POST['gender'] !="" AND $_POST['qualification'] !="" AND $_POST['fmember'] !="" AND $_POST['ffirstname'] !="" AND $_POST['flastname'] !="" AND $_POST['email'] !="" AND $_POST['phonenumber'] !="" AND $_POST['campus'] !="" AND $_POST['fnumber'] !=""){
      ...
      if($resultnum > 0){
         ...
         header("location:officestaffreg.php");
      }
      else{
         
      $query ="INSERT INTO `officestaf`(`sec`, `firstname`, `lastname`, `uniqe`, `section`, `homeaddr`, `gender`,`qualification`, `fmember`, `fmemberfirstname`, `fmemberlastname`, `email`, `phonenumber`,salary,fnumber,`password`,`campus`,school,name,lastattendance) VALUES ('$sec','$firstname','$lastname','$uniq','$section','$homeaddr','$gender','$qualification','$fmember','$ffirstname','$flastname','$email','$phonenumber','$salary','$fnumber','$password','$campus','$school','$name',CURRENT_TIMESTAMP())";
...
?>
     ...
     <!-- popperEditclassliste -->
        ...
        <div class="h" style=" "> <button class="btn btn-dark addcampus" >Add campus</button> <a href="registrer.php" class="btn btn-secondary btn-dark" style="text-align: center;">teacher</a>    <a href="registrer-student.php" class="btn btn-secondary btn-dark" >student</a>   <a href="officestaffreg.php" class="btn btn-primary">office staff</a></div>
        ...
        <form action="<?=$_SERVER['PHP_SELF']?>" class="col-12 col-md-8 d-flex flex-column gap-2" method="POST">
             ...
             <div class="formbox">
                ...
                <!--  -->
             <div class="formbox text-capitalize ">
