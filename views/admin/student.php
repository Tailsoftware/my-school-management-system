...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    if($teachername != null){
        if(isset($teachername['campusselect2']) AND isset($teachername['classteachrsname2'])){

     $campusselect = $teachername['campusselect2']; 
     $teacherid = $teachername['classteachrsname2'];
    ...
    <div class="col-12 pt-5  d-flex flex-column g-2 align-items-center  appentteachersresponse" style="height: 90%; overflow-y: scroll; padding-bottom: 1cm ;">
     ...
     <!-- popperteachere -->
            ...
            <div class="col-12 col-md-8 h-75  m-auto position-relative" style="padding: 10px;max-width: 100vw;">
               <a href="registrer-student.php" class="btn btn-dark text-capitalize"> Add new student</a>
...
<!-- e -->
   ...
   <?php
     $query2 = "SELECT * FROM students WHERE school = '$school' AND campus = '$campusselect' ORDER BY lastattendance ASC";
...
<tr class="d">
                        <td class="dc"><?=$j?></td>
                        <td class="dc" style=" line-break: break-all;"> <a href="" class="teachersdetails2"><?=$id?> <input type="hidden" name="teacherid" value="<?=$id?>" class="teacherid"> <input type="hidden" class="campusselect" value="<?=$campusselect?>"></a></td>
